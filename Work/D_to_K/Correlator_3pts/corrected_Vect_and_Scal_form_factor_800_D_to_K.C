...
int main(){
  ...
  fclose(fin);
   ...
   ////////////// LEGGO GLI EL. DI MATRICE, f0_S E LE LORO CORREZIONI
    ...
    sprintf(open_V0_correction, "OUTPUT_SMEAR/%s/%s/hyp_corrections/V0/%s/%s/%s/V0_hyp_corr.%s.m1m2_sc.th_%s%s.out", dir_S[iS].c_str(), dir_E[iE].c_str(), strategy[istrategy].c_str(), beta_V[ibeta].c_str(), mu_sea_1[ibeta][imusea].c_str(), mu_sea_2[imusea].c_str(), th_[ith1].c_str(), th_[ith2].c_str());
    sprintf(open_Vi_correction, "OUTPUT_SMEAR/%s/%s/hyp_corrections/Vi/%s/%s/%s/Vi_hyp_corr.%s.m1m2_sc.th_%s%s.out", dir_S[iS].c_str(), dir_E[iE].c_str(), strategy[istrategy].c_str(), beta_V[ibeta].c_str(), mu_sea_1[ibeta][imusea].c_str(), mu_sea_2[imusea].c_str(), th_[ith1].c_str(), th_[ith2].c_str());
    sprintf(open_f0_S_correction, "OUTPUT_SMEAR/%s/%s/hyp_corrections/f0_S/%s/%s/%s/f0_S_hyp_corr.%s.m1m2_sc.th_%s%s.out", dir_S[iS].c_str(), dir_E[iE].c_str(), strategy[istrategy].c_str(), beta_V[ibeta].c_str(), mu_sea_1[ibeta][imusea].c_str(), mu_sea_2[imusea].c_str(), th_[ith1].c_str(), th_[ith2].c_str());
  ...
  /////////// INIZIO OUTPUT
     ...
     if(no_correction == 0){
       ...
       sprintf(file_out_fzero, "OUTPUT_SMEAR/%s/%s/fzero_corrected/%s/%s/%s/fzero_corrected.%s.m1m2_sc.th_%s%s.out", dir_S[iS].c_str(), dir_E[iE].c_str(), strategy[istrategy].c_str(), beta_V[ibeta].c_str(), mu_sea_1[ibeta][imusea].c_str(), mu_sea_2[imusea].c_str(), th_[ith1].c_str(), th_[ith2].c_str());
       sprintf(file_out_fplus, "OUTPUT_SMEAR/%s/%s/fplus_corrected/%s/%s/%s/fplus_corrected.%s.m1m2_sc.th_%s%s.out", dir_S[iS].c_str(), dir_E[iE].c_str(), strategy[istrategy].c_str(), beta_V[ibeta].c_str(), mu_sea_1[ibeta][imusea].c_str(), mu_sea_2[imusea].c_str(), th_[ith1].c_str(), th_[ith2].c_str());
       sprintf(file_out_fminus, "OUTPUT_SMEAR/%s/%s/fminus_corrected/%s/%s/%s/fminus_corrected.%s.m1m2_sc.th_%s%s.out", dir_S[iS].c_str(), dir_E[iE].c_str(), strategy[istrategy].c_str(), beta_V[ibeta].c_str(), mu_sea_1[ibeta][imusea].c_str(), mu_sea_2[imusea].c_str(), th_[ith1].c_str(), th_[ith2].c_str());

     }else if(no_correction == 1){

       sprintf(file_out_fzero, "OUTPUT_SMEAR/%s/%s/fzero_corrected/%s/%s/%s/fzero_no_corrected.%s.m1m2_sc.th_%s%s.out", dir_S[iS].c_str(), dir_E[iE].c_str(), strategy[istrategy].c_str(), beta_V[ibeta].c_str(), mu_sea_1[ibeta][imusea].c_str(), mu_sea_2[imusea].c_str(), th_[ith1].c_str(), th_[ith2].c_str());
       sprintf(file_out_fplus, "OUTPUT_SMEAR/%s/%s/fplus_corrected/%s/%s/%s/fplus_no_corrected.%s.m1m2_sc.th_%s%s.out", dir_S[iS].c_str(), dir_E[iE].c_str(), strategy[istrategy].c_str(), beta_V[ibeta].c_str(), mu_sea_1[ibeta][imusea].c_str(), mu_sea_2[imusea].c_str(), th_[ith1].c_str(), th_[ith2].c_str());
       sprintf(file_out_fminus, "OUTPUT_SMEAR/%s/%s/fminus_corrected/%s/%s/%s/fminus_no_corrected.%s.m1m2_sc.th_%s%s.out", dir_S[iS].c_str(), dir_E[iE].c_str(), strategy[istrategy].c_str(), beta_V[ibeta].c_str(), mu_sea_1[ibeta][imusea].c_str(), mu_sea_2[imusea].c_str(), th_[ith1].c_str(), th_[ith2].c_str());
