...
g++ -O$optimization -o fit_syst_D_to_pi fit_syst_D_to_pi.C $func1 $func2 $func3 $func4 $func5 $func6 $func7 $func8 $(rootlib) $(gsllib) -I$header_path -D $declared_Vcd_cov_lat -D $declared_Belle
